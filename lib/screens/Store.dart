    ...
    return Consumer<ProductProvider>(
      builder: (context, provider, child) {
        ...
        final filtered = products.where((p) {
          ...
          final matchesCat = _selectedCategoryLabel == 'ทั้งหมด'
              ? true
              : p.category.label == _selectedCategoryLabel;
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ChoiceChip(
                      ...
                      selected: selected,
                      onSelected: (_) =>
                          setState(() => _selectedCategoryLabel = catLabel),
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return StoreItemCard(
                      product: p,
                      inCart: provider.cart[p.id] ?? 0,
                      onAdd: () => provider.addToCart(p.id),
                      onRemove: () => provider.removeFromCart(p.id),
                    );
                  },
                ),
              ),
